...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <!-- <a name="" id="" class="btn btn-outline-dark" href="admin_show_allprod.php" role="button" style="margin-left: 20px;">BACK</a> -->
            ...
            <div class="block">
              <center><h4 class="display-5" style="margin-bottom: 70px;"><img src="images/con" class="img-fluid rounded-top" alt="">VIEW DETAILS</h4></center>
            ...
            <form action="shop.html" method="post" enctype="multipart/form-data">
            <div class="mb-3">
          ...
          <input type="hidden" class="form-control" name="id" id="inputName" placeholder="" value='<?php echo "{$rows['id']}"; ?>'>
                ...
                <div class="col-6">
                  <div class="form-group">
                    <label class="text-black" for="fname"
                      style="padding-left: 10px; margin-bottom: 5px; font-size: large;"><b>NAME :</b> <br><?php echo "{$rows['name']}";?></label>
                ...
                <div class="col-6">
                  <div class="form-group">
                    <label class="text-black" for="lname"
                      style="padding-left: 10px; margin-bottom: 5px; font-size: large;"><b>CATEGORY: </b><br> <?php echo "{$rows['category']}";?></label>
                    <!-- <input type="text" class="form-control" id="" name="category"
                      style="padding: 15px; border-radius: 20px;" value=''> -->
                  </div>
                </div>
              </div><br>
              <div class="row">
               <div class="form-group">
                    <label class="text-black" for="fname"
                      style="padding-left: 10px; margin-bottom: 5px; font-size: large;"><b>DESCRIPTION:</b> <br> <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsum fugiat voluptate ipsa laborum debitis necessitatibus esse repudiandae numquam accusamus consequuntur.</p></label>
                    <!-- <input type="text" class="form-control" id="" name="name"
                      style="padding: 15px; border-radius: 20px;" value='<?php echo "{$rows['name']}";?>'> -->
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    <label class="text-black" for="fname"
                      style="padding-left: 10px; margin-bottom: 5px; font-size: large;"><b>MRP:</b> <br><del> <?php echo "{$rows['mrp']}";?></del></label>
                ...
                <div class="col-6">
                  <div class="form-group">
                    <label class="text-black" for="lname"
                      style="padding-left: 10px; margin-bottom: 5px; font-size: large;"><b>OFFER PRICE:</b> <?php echo "{$rows['sp']}";?></label>
  ...
  <input type="file" class="form-control" name="image" id="" placeholder="" aria-describedby="fileHelpId" style="padding: 15px; border-radius: 20px;">
              ...
              <button type="submit" class="btn btn-primary-hover-outline"
                style="background-color: black; color: white; padding: 15px; border-radius: 20px; font-weight: bolder; padding-left: 20px; padding-right: 20px;">&nbsp;BACK 
                &nbsp;TO SHOP&nbsp;</button>
            </form>
        </div>
