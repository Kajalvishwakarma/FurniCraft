...
$sql = "SELECT * FROM products WHERE category = 'shelves';
";
  ...
  >
    ...
    <div class='card' style='border: white;'>
      ...
      <b><p class='card-text'>NAME: {$rows['name']}</p></b>
        ...
        <span><a name='' id='' class='btn btn-outline-success' href='checkout.html?id={$rows['id']}' role='button'>BUY NOW</a>
        <a name='' id='' class='btn btn-outline-warning' href='viewprod.php?id={$rows['id']}' role='button'>VIEW</a></span>
      </div>
    </div>
  </div>";
    }
